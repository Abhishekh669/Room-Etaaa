  ...
  return (
    <div className="p-6 border rounded-lg bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="font-medium">Rs{room.roomBilling.roomCost?.toFixed(2) || "0.00"}</p>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="font-medium">Rs{room.roomBilling.electricity?.toFixed(2) || "0.00"}</p>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="font-medium">Rs{room.roomBilling.water?.toFixed(2) || "0.00"}</p>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="font-medium">Rs{room.roomBilling.internet?.toFixed(2) || "0.00"}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <p className="text-xl font-bold">Rs{calculateTotalCost().toFixed(2)}</p>
      </div>
