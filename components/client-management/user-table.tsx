...
interface UserTableProps {
  users: UserForOwnerType[]
  onViewDetails: (user: UserForOwnerType) => void
  onDeleteUser: (user: UserForOwnerType) => void
}
              ...
              <TableCell>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    >
                      {user.rooms && user.rooms.length > 0 ? "Remove from rooms" : "Delete user"}
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </TableCell>
