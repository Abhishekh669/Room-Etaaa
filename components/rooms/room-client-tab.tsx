...
export const RoomClientsTab = ({ room }: RoomClientsTabProps) => {
  return (
    <div className="p-6 border rounded-lg">
      ...
      {room.client && (
        <div className="mb-6">
          <h4 className="text-md font-medium mb-2">Primary Client</h4>
          <Card className="p-4">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium">{room.client.name}</p>
                <p className="text-sm text-muted-foreground">{room.client.email}</p>
                <p className="text-sm text-muted-foreground">{room.client.phoneNumber}</p>
              </div>
            </div>
          </Card>
        </div>
      ...
      {room.otherClients && room.otherClients.length > 0 && (
        <div>
          <h4 className="text-md font-medium mb-2">Other Clients</h4>
          <div className="space-y-4">
            {room.otherClients.map((client) => (
      ...
      {!room.client && (!room.otherClients || room.otherClients.length === 0) && (
